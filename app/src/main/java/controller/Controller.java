...
public class Controller {
  ...
  public boolean takeScreenshot(String fileName) {
    ...
    try {
       ...
       * 3rd, use Files.createDirectories to make the folder structure for
       * /Screenshots/playerName/
       * -this will regenerate the folder structure if user deleted at any point
       * -screenshots will NOT save if the folder path doesn't exist when imageIO
       * writes.
       * 4th, use ImageIO.write to actually write the "img" created earlier
       * 5th, String the save location, calc Path, calculate boolean
       * Files.exists(Path)
